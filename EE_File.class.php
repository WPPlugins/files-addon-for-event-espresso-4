...
define('EE_FILE_ADMIN', EE_FILE_PATH . 'admin/file/');
    ...
    public static function register_addon()
    {
        ...
        EE_Register_Addon::register(
            ...
            array(
                ...
                'admin_path'            => EE_FILE_ADMIN,
                'admin_callback'        => '',
                'config_class'          => 'EE_File_Config',
                'config_name'           => 'EE_File',
                'autoloader_paths' => array(
                    'EE_File'   => EE_FILE_PATH . 'EE_File.class.php',
                    'EE_File_Config' => EE_FILE_PATH . 'EE_File_Config.php',
                    'FILE_Page'       => EE_FILE_ADMIN . 'File_Admin_Page.core.php',
                    'File_Admin_Page_Init' => EE_FILE_ADMIN . 'Ee_File_Admin_Page_Init.core.php',
                ),
